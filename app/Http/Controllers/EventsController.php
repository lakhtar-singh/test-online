...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops(Event    $eventObject) {
        return $eventObject->with('workshops')->get();
    }
    ...
    public function getFutureEventsWithWorkshops(Event $eventObject) {
        return $eventObject->has('future_workshops')->with('future_workshops')->get();
    }
}
